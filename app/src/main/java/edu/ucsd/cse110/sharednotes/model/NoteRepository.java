...
public class NoteRepository {
    ...
    public LiveData<Note> getRemote(String title){
        ...
        MutableLiveData<Note> realTimeNote = new MutableLiveData<>();

        var executor = Executors.newSingleThreadScheduledExecutor();
        poller = executor.scheduleAtFixedRate(() -> realTimeNote.postValue(api.getNote(title)), 0, 3, TimeUnit.SECONDS);
